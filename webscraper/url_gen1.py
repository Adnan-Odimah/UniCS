...
async def main():
    ...
    for i, proxy in enumerate(PROXIES):
        ...
        # Create individual tasks instead of a list of coroutines
        for index in range(start_offset, start_offset + idx_per_proxy):
            tasks.append(fetch(index, session, proxy, scraping_run_id, token))
